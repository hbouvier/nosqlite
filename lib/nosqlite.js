module.exports = function () {
    ...
    Database.prototype.drop = function (bucket) {
        return sqliteImpl.drop(this, bucket);
    };
    ...
    function Bucket(db, name) {
        ...
        this.contentTypeText = 'text/plain; charset="UTF-8"';
    }
    ...
    var sqliteImpl = (function () {
        ...
        function sqlUpsert(db, bucket, key, value, contentType) {
            ...
            if (typeof(key) === 'object') {
                document = {$id:key.id, $origrev:key.rev, $rev:uuid.v1(), $value:stringyIfObject(value), $contentType:contentType};
                statements.push( {
                    level     : 'info',
                    method    : 'update',
                    options   : null,
                ...
                document = {$id:key, $rev:uuid.v1(), $value:stringyIfObject(value), $contentType:contentType};
                statements.push( {
                    level     : 'info',
                    method    : 'insert',
                    options   : null,
