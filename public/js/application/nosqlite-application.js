...
angular.module('nosqliteApplication', ['ngRoute', 'nosqliteServices', 'nosqliteControllers', 'nosqliteBucketControllers', 'nosqliteDocumentControllers'])
    ...
    .config(['$httpProvider', function ($httpProvider) {
        ...
        /*
         ...
         console.log('defaults:transformRequest:data=', data);
         return data;
         };
         */
    }])
    ...
    .directive('ngPrettifyJson', function ($parse) {
        return {
            link: function (scope, element, attrs) {
                ...
                var model = $parse(attrs.ngPrettifyJson)(scope);

                var html = (typeof(model) === 'object') ? '<pre>' + JSONprettify(model) + '</pre>' : '<textarea class="show-document" rows="auto" cols="auto" readonly>' + model + '</textarea>';
